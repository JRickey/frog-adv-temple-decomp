...
void GameMode_Scene18(void)
{
    ...
    do {
        ...
        default:
            goto tail;
        case 0: {
            unsigned long long *mask6;
            unsigned long long *mask7;
            unsigned long long *mask22;

            mask6 = &mask6Storage;
            mask7 = &mask7Storage;
            mask22 = &mask22Storage;
        ...
        case 3: {
            ...
            Scene_UpdateCollisionAndTile((u32)slots6, (u32)mask6, (u32)slots7, (u32)mask7, slots22p, mask22);
            gGameStuff._unk14++;
            break;
        }
        case 4: {
