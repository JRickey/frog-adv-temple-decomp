...
/* --- Credits_RunScript: non-matching reference (NAKED .incbin below provides the matching bytes) --- */
#ifdef NON_MATCHING
...
#else
NAKED void Credits_RunScript(void)
{
    asm(".incbin \"frog_us_baserom.gba\", 0x1ada8, 0x304\n");
}
#endif /* NON_MATCHING */
