...
void sub_0802C7EC(void)
{
    ...
    if ((u8)sub_0800679C(base6110, 3, 1)) {
        sub_0802C75C();
        sub_08006600(base6110, 3, 7);
        sub_080066C4(base6110, 3, 1);
    ...
    if ((u8)sub_0800679C(base6110, 3, 7) == 0)
        return;
    ...
    if (gGameStuff._unk00 - *(u32 *)((base3720 = (u8 *)gEntities) + 0xd4) > 240) {
        ...
        sub_080066C4(base6110, 3, 7);
        sub_080066C4(base6110, 3, 2);
        sub_08020C78(106);
        sub_08006600(base6110, 3, 9);
    ...
    switch (spawnMask) {
    case 0:
        sub_08021510(3, sLevelLayout_31807C, 4, base6110, spawnMask);
        break;
    case 1:
        sub_08021510(3, sLevelLayout_3180AC, 4, base6110, 0);
        break;
    case 2:
        sub_08021510(3, sLevelLayout_3180DC, 4, base6110, 0);
        break;
    case 3:
        sub_08021510(3, sLevelLayout_31810C, 4, base6110, 0);
        break;
    }
}
