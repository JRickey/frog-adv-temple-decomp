...
/* Mode-handler tail called from sub_08001D54. Four independent probes
 * over the gIwram_35E0 tile cache + gIwram_3720 counter:
 *
 *   1. sub_0800B918(arg0, arg1, 5) — enqueue with kind=5.
 *   2. If (gIwram_35E0._field_10 & 0x40), look up the tile under the
 *      current entity (gIwram_35E0 _field_18/19/8/A → sub_0800CD88) and
 *      raise/lower a state flag on the 0x03006110 cluster:
 *        tile == 20 → sub_08006600(0x03006110, 8, 0)
 ...
 *
 * Sibling of sub_08001508's case-3 fallthrough block (which uses
