...
import { CappedOutput } from '~/shared/capped-output';
import type { PlatformTarget } from '~/shared/platform-target';
...
export class DecompPermuter {
  ...
  constructor() {
    // Resolve vendor/decomp-permuter relative to this file.
    // tools/agent/ts/shared/decomp-permuter.ts → repo root is four levels up.
