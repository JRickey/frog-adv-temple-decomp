...
struct IwramAt34A0 {
    u8 _field_00;   /* +0: live selector byte, cleared by MenuRouter_ResetCursor2 */
...
struct IwramAt35E0 {
    ...
    u8 initials[3]; /* +0x20: player initials entered on the save-slot screen (0x03003600, SaveCommit src) */
};
