...
- **Functions decompiled to C**: 58 / ~513 estimated total (**11.3%**)
  - peeled-but-still-asm: 70
  - estimate range (lower / upper): 335 / 1140
- **Data deblobbed**: 186.9 KiB of 4.00 MiB (**4.56%**)
  - raw INCBIN bytes: 3.82 MiB (95.4% of ROM)
  - `database.json` entries: 209
