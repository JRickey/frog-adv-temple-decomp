...
- **Functions decompiled to C**: 775 / ~1114 estimated total (**69.6%**)
  - true pure-C matches: 711
  - NAKED+NON_MATCHING (asm fallback, byte-matches but not pure C): 64
  - peeled-but-still-asm: 260
  - not yet in C (non-matching tail — asm slices + raw INCBIN): ~339
