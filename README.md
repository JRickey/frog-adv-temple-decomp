...
- **Functions decompiled to C**: 778 / ~1114 estimated total (**69.8%**)
  - true pure-C matches: 714
  - NAKED+NON_MATCHING (asm fallback, byte-matches but not pure C): 64
  - peeled-but-still-asm: 259
  - not yet in C (non-matching tail — asm slices + raw INCBIN): ~336
