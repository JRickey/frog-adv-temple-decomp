...
- **Functions decompiled to C**: 773 / ~1114 estimated total (**69.4%**)
  - true pure-C matches: 709
  - NAKED+NON_MATCHING (asm fallback, byte-matches but not pure C): 64
  - peeled-but-still-asm: 261
  - not yet in C (non-matching tail — asm slices + raw INCBIN): ~341
