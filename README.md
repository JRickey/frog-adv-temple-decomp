...
- **Functions decompiled to C**: 232 / ~513 estimated total (**45.2%**)
  - true pure-C matches: 189
  - NAKED+NON_MATCHING (asm fallback, byte-matches but not pure C): 43
  - peeled-but-still-asm: 151
  - estimate range (lower / upper): 335 / 1140
- **Data deblobbed**: 506.9 KiB of 4.00 MiB (**12.38%**)
  - raw INCBIN bytes: 3.50 MiB (87.6% of ROM)
