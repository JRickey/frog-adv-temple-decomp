...
- **Functions decompiled to C**: 772 / ~1114 estimated total (**69.3%**)
  - true pure-C matches: 708
  - NAKED+NON_MATCHING (asm fallback, byte-matches but not pure C): 64
  - peeled-but-still-asm: 262
  - not yet in C (non-matching tail — asm slices + raw INCBIN): ~342
