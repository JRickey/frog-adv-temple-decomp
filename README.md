...
- **Functions decompiled to C**: 92 / ~513 estimated total (**17.9%**)
  - peeled-but-still-asm: 82
  - estimate range (lower / upper): 335 / 1140
- **Data deblobbed**: 456.5 KiB of 4.00 MiB (**11.14%**)
  - raw INCBIN bytes: 3.55 MiB (88.9% of ROM)
