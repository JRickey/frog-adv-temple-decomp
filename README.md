...
- **Functions decompiled to C**: 102 / ~513 estimated total (**19.9%**)
  - peeled-but-still-asm: 88
  - estimate range (lower / upper): 335 / 1140
- **Data deblobbed**: 460.3 KiB of 4.00 MiB (**11.24%**)
  - raw INCBIN bytes: 3.55 MiB (88.8% of ROM)
