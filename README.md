...
- **Functions decompiled to C**: 109 / ~513 estimated total (**21.2%**)
  - peeled-but-still-asm: 94
  - estimate range (lower / upper): 335 / 1140
- **Data deblobbed**: 462.2 KiB of 4.00 MiB (**11.28%**)
  - raw INCBIN bytes: 3.55 MiB (88.7% of ROM)
