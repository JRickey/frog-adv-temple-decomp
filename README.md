...
- **Functions decompiled to C**: 38 / ~513 estimated total (**7.4%**)
  - peeled-but-still-asm: 17
  - estimate range (lower / upper): 335 / 1140
- **Data deblobbed**: 76.4 KiB of 4.00 MiB (**1.87%**)
  - raw INCBIN bytes: 3.93 MiB (98.1% of ROM)
  - `database.json` entries: 111
