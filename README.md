...
- **Functions decompiled to C**: 32 / ~513 estimated total (**6.2%**)
  - peeled-but-still-asm: 15
  - estimate range (lower / upper): 335 / 1140
- **Data deblobbed**: 70.4 KiB of 4.00 MiB (**1.72%**)
  - raw INCBIN bytes: 3.93 MiB (98.3% of ROM)
  - `database.json` entries: 75
