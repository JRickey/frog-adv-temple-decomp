...
@ Range:  [0x083c0000, 0x083d0000)  (0x10000 bytes)
@
...
@ this bucket and its neighbours, at their correct baserom addresses.
        ...
        .align  2
        .global text_083c0000
        .type   text_083c0000, %object
text_083c0000:
        .incbin "frog_us_baserom.gba", 0x003c0000, 0x00010000
        .size   text_083c0000, . - text_083c0000
