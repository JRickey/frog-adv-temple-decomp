...
@ Range:  [0x08012588, 0x08012604)  (124 bytes, thumb mode)
@ Re-peel:  python3 tools/disasm/peel.py --start 0x8012588 --end 0x8012604 --mode thumb

        .include "asm/macros.inc"
        .syntax unified

@ Disassembly preview (the bytes come from the INCBIN below):
@   0x08012588: b500        push	{lr}
@   0x0801258a: 2002        movs	r0, #2
@   0x0801258c: f7fc        fc82 	bl	0xee94
@   0x08012590: 4904        ldr	r1, [pc, #16]	@ (0x125a4)
@   0x08012592: 4a05        ldr	r2, [pc, #20]	@ (0x125a8)
@   0x08012594: 1c10        adds	r0, r2, #0
@   0x08012596: 8008        strh	r0, [r1, #0]
@   0x08012598: 3102        adds	r1, #2
@   0x0801259a: 4a04        ldr	r2, [pc, #16]	@ (0x125ac)
@   0x0801259c: 1c10        adds	r0, r2, #0
@   0x0801259e: 8008        strh	r0, [r1, #0]
@   0x080125a0: bc01        pop	{r0}
@   0x080125a2: 4700        bx	r0
@   0x080125a4: 0050        lsls	r0, r2, #1
@   0x080125a6: 0400        lsls	r0, r0, #16
@   0x080125a8: 1744        asrs	r4, r0, #29
@   0x080125aa: 0000        movs	r0, r0
@   0x080125ac: 020e        lsls	r6, r1, #8
@   0x080125ae: 0000        movs	r0, r0
...
@   0x08012602: 0300        lsls	r0, r0, #12
        ...
        thumb_func_start sub_08012588
sub_08012588: @ 0x08012588
        .incbin "frog_us_baserom.gba", 0x12588, 0x7c
        thumb_func_end sub_08012588
