...
@ Range:  [0x0802e4e8, 0x0802e5d8)  (240 bytes, thumb mode)
@ Re-peel:  python3 tools/disasm/peel.py --start 0x802e4e8 --end 0x802e5d8 --mode thumb

        .include "asm/macros.inc"
        .syntax unified

@ Disassembly preview (the bytes come from the INCBIN below):
@   0x0802e4e8: b510        push	{r4, lr}
@   0x0802e4ea: 1c0c        adds	r4, r1, #0
@   0x0802e4ec: 2800        cmp	r0, #0
@   0x0802e4ee: d017        beq.n	0x2e520
@   0x0802e4f0: 0c01        lsrs	r1, r0, #16
@   0x0802e4f2: 20ff        movs	r0, #255	@ 0xff
@   0x0802e4f4: 4001        ands	r1, r0
@   0x0802e4f6: 4808        ldr	r0, [pc, #32]	@ (0x2e518)
@   0x0802e4f8: 6803        ldr	r3, [r0, #0]
@   0x0802e4fa: 1c1a        adds	r2, r3, #0
@   0x0802e4fc: 32c0        adds	r2, #192	@ 0xc0
@   0x0802e4fe: 00c8        lsls	r0, r1, #3
@   0x0802e500: 1a40        subs	r0, r0, r1
@   0x0802e502: 0080        lsls	r0, r0, #2
@   0x0802e504: 6811        ldr	r1, [r2, #0]
@   0x0802e506: 1809        adds	r1, r1, r0
@   0x0802e508: 2c00        cmp	r4, #0
@   0x0802e50a: d007        beq.n	0x2e51c
@   0x0802e50c: 2087        movs	r0, #135	@ 0x87
@   0x0802e50e: 0040        lsls	r0, r0, #1
@   0x0802e510: 181a        adds	r2, r3, r0
@   0x0802e512: 7810        ldrb	r0, [r2, #0]
@   0x0802e514: e003        b.n	0x2e51e
@   0x0802e516: 0000        movs	r0, r0
@   0x0802e518: 65e0        str	r0, [r4, #92]	@ 0x5c
@   0x0802e51a: 0300        lsls	r0, r0, #12
@   0x0802e51c: 2000        movs	r0, #0
@   0x0802e51e: 76c8        strb	r0, [r1, #27]
@   0x0802e520: bc10        pop	{r4}
@   0x0802e522: bc01        pop	{r0}
@   0x0802e524: 4700        bx	r0
@   0x0802e526: 0000        movs	r0, r0
...
sub_0802E4E8: @ 0x0802e4e8
        .incbin "frog_us_baserom.gba", 0x2e4e8, 0xf0
        thumb_func_end sub_0802E4E8
